...
final class BatchPianoDispatcherTests: XCTestCase {
    ...
    var dispatcher: BatchPianoDispatcher! = nil
    var pianoEventSenderMock: PianoEventSenderMock! = nil
...
extension Event: MockUsable {
    ...
    public func equal(to: InstantMock.MockUsable?) -> Bool {
        ...
        return self.name == value.name && NSDictionary(dictionary: self.data).isEqual(to: value.data)
    }
